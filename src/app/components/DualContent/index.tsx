  ...
  return (
    <div className="px-6 py-12 text-center flex flex-col md:flex-row items-center justify-center md:justify-around text-black-text-color md:text-left">
      <div className="w-full md:w-1/2">
        ...
        <p className="py-4">
          Olá! Sou a Dra. Rafaela, dentista com anos de experiência dedicado a
          cuidar da sua saúde bucal com atenção, profissionalismo e empatia.
          Estou aqui para transformar seu sorriso, proporcionando tratamentos
